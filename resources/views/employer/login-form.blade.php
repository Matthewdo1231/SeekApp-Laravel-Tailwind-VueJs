<x-layout>
    <form id="sign-up-seeker" method="POST" action="/employer/authenticate" class="flex flex-row justify-center bg-gray-200">
        @csrf
       <div class="flex flex-col mt-32 w-[38rem] mb-[28rem] bg-gray-100 p-6 rounded-lg shadow-lg shadow-gray-400"> 
    
         <p class="text-2xl font-bold flex justify-center">Login <span class="text-orange-500 ml-2">as Employer</span></p>
